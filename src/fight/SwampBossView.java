...
public class SwampBossView {
    

        JFrame swampBossFightJFrame = new JFrame();
        ...
        public JLabel swampBoss, swampBossflip;
        public JLabel swampBossHp;
         ...
         *
         */
        public void swampBossFightFrame(){

            swampBossFightJFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            swampBossFightJFrame.setSize(1920, 1080);
            swampBossFightJFrame.setLayout(null);
            swampBossFightJFrame.setExtendedState(JFrame.MAXIMIZED_BOTH);
            swampBossFightJFrame.setUndecorated(true);

            ImageIcon background = new ImageIcon("swamp.jpg");
            swampBossFightJFrame.setContentPane(new JLabel(background));
            ...
            swampBossFightJFrame.add(energy);
            swampBossFightJFrame.add(block);
            swampBossFightJFrame.add(whosTurn);

            swampBossFightJFrame.add(targetarrow);

            swampBossFightJFrame.add(attackButton);
            swampBossFightJFrame.add(blockButton);
            swampBossFightJFrame.add(itemButton);
            swampBossFightJFrame.add(skillButton);
            swampBossFightJFrame.add(endTurnButton);

            swampBossFightJFrame.add(playersHp);
            swampBossFightJFrame.add(swampBossHp);
            swampBossFightJFrame.add(player1Hp);
            swampBossFightJFrame.add(player2Hp);
            swampBossFightJFrame.add(player3Hp);
            swampBossFightJFrame.add(player4Hp);

            swampBossFightJFrame.add(skill1Button);
            swampBossFightJFrame.add(skill2Button);
            swampBossFightJFrame.add(skill3Button);
            swampBossFightJFrame.add(skill4Button);
            swampBossFightJFrame.add(returnButton);

            swampBossFightJFrame.add(healWarriorButton);
            swampBossFightJFrame.add(healRangerButton);
            swampBossFightJFrame.add(healMageButton);
            swampBossFightJFrame.add(healHealerButton);

            swampBossFightJFrame.add(arrow);
            swampBossFightJFrame.add(volley1);
            swampBossFightJFrame.add(volley2);
            swampBossFightJFrame.add(volley3);
            swampBossFightJFrame.add(blast);
            swampBossFightJFrame.add(fireStorm);
            swampBossFightJFrame.add(flame);
            swampBossFightJFrame.add(smallPyroBlast);
            swampBossFightJFrame.add(mediumPyroBlast);
            swampBossFightJFrame.add(bigPyroBlast);
            swampBossFightJFrame.add(swordIcon);
            swampBossFightJFrame.add(demoSword1);
            swampBossFightJFrame.add(bomb);
            swampBossFightJFrame.add(explode);
            swampBossFightJFrame.add(stealthranger);
            swampBossFightJFrame.add(trap);
            swampBossFightJFrame.add(holyLight);
            swampBossFightJFrame.add(smallHolyLight);
            swampBossFightJFrame.add(groupHeal1);
            swampBossFightJFrame.add(groupHeal2);
            swampBossFightJFrame.add(groupHeal3);
            swampBossFightJFrame.add(groupHeal4);

            //enemies
            swampBossFightJFrame.add(swampBoss);
            swampBossFightJFrame.add(swampBossflip);
            //player
            swampBossFightJFrame.add(ranger);
            swampBossFightJFrame.add(warrior);
            swampBossFightJFrame.add(mage);
            swampBossFightJFrame.add(healer);
            ...
            swampBossFightJFrame.setVisible(true);
        }
        ...
        private void importLabels(){
            ...
            swampBossHp.setFont(pixelMplus.deriveFont(30f));
            swampBossHp.setForeground(Color.black);
            Dimension wolf1HpSize = swampBossHp.getPreferredSize();
            swampBossHp.setBounds(640, 560, wolf1HpSize.width, wolf1HpSize.height);
         ...
         */
        //Get goblin gif.
        private void importswampBossGif(){
            swampBoss = new JLabel();
            swampBoss.setIcon(new ImageIcon("shrek.gif"));
            Dimension glarbSize = swampBoss.getPreferredSize();
            swampBoss.setBounds(850, 300, glarbSize.width, glarbSize.height);

            swampBossflip = new JLabel();
            swampBossflip.setIcon(new ImageIcon("shrek.gif"));
            swampBossflip.setBounds(850, 300, glarbSize.width, glarbSize.height);
        }
